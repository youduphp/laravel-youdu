...
return (new Config())
    ->setHeaderComment(
        projectName: 'laravel-youdu',
        projectLink: 'https://github.com/youduphp/laravel-youdu',
        projectDocument: 'https://github.com/youduphp/laravel-youdu/blob/main/README.md',
        contacts: [
